...
class ByProjectKeyCategoriesImportSinkKeyByImportSinkKeyResourceKeyByResourceKeyRequestBuilder:
    ...
    def delete(
        ...
        *,
        ...
        response = self._client._delete(
            endpoint=f"/{self._project_key}/categories/importSinkKey={self._import_sink_key}/resourceKey={self._resource_key}",
            params={},
            headers=headers,
            options=options,
        )
