...
from ...models.importrequests import DiscountCodeImportRequest, ImportResponse
    ...
    def post(
        ...
        *,
        ...
        response = self._client._post(
            endpoint=f"/{self._project_key}/discount-codes/import-containers/{self._import_container_key}",
            params={},
            json=body.serialize(),
