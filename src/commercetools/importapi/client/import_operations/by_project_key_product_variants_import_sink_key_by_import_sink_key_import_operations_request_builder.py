...
from .by_project_key_product_variants_import_sink_key_by_import_sink_key_import_operations_by_id_request_builder import (
    ...
    def get(
        ...
        *,
        ...
        response = self._client._get(
            endpoint=f"/{self._project_key}/product-variants/importSinkKey={self._import_sink_key}/import-operations",
            params={
                "limit": limit,
                "offset": offset,
                "sort": sort,
