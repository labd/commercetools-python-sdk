...
from ...models.importrequests import ImportResponse, OrderPatchImportRequest
from ..import_operations.by_project_key_order_patches_import_sink_key_by_import_sink_key_import_operations_request_builder import (
    ...
    def post(
        ...
        *,
        ...
        response = self._client._post(
            endpoint=f"/{self._project_key}/order-patches/importSinkKey={self._import_sink_key}",
            params={},
            json=body.serialize(),
