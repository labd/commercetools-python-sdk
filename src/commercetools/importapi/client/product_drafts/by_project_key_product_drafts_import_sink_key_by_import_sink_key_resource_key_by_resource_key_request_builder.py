...
class ByProjectKeyProductDraftsImportSinkKeyByImportSinkKeyResourceKeyByResourceKeyRequestBuilder:
    ...
    def delete(
        ...
        return self._client._delete(
            endpoint=f"/{self._project_key}/product-drafts/importSinkKey={self._import_sink_key}/resourceKey={self._resource_key}",
            params={},
