...
from ..reset.by_project_key_in_store_key_by_store_key_me_password_reset_request_builder import (
...
class ByProjectKeyInStoreKeyByStoreKeyMePasswordRequestBuilder:
    ...
    def reset(self) -> ByProjectKeyInStoreKeyByStoreKeyMePasswordResetRequestBuilder:
    ...
    def post(
        ...
        *,
        ...
        response = self._client._post(
            endpoint=f"/{self._project_key}/in-store/key={self._store_key}/me/password",
            params={},
            json=body.serialize(),
