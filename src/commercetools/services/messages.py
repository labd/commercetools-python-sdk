...
class MessageService(abstract.AbstractService):
    ...
    def get_by_id(self, id: str, *, expand: OptionalListStr = None) -> types.Message:
        params = self._serialize_params({"expand": expand}, traits.ExpandableSchema)
        return self._client._get(
            endpoint=f"messages/{id}", params=params, schema_cls=schemas.MessageSchema
        )
    ...
    def query(
        ...
        *,
    ...
    ) -> types.MessagePagedQueryResponse:
        ...
        return self._client._get(
            endpoint="messages",
            params=params,
            schema_cls=schemas.MessagePagedQueryResponseSchema,
        )
