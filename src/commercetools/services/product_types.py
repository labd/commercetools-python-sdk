...
class ProductTypeService(AbstractService):
    ...
    def get_by_key(self, key: str) -> types.ProductType:
        return self._client._get(f"product-types/key={key}", [], schemas.ProductTypeSchema)
    ...
    def create(self, draft: types.ProductTypeDraft) -> types.ProductType:
        return self._client._post(
            "product-types", [], draft, schemas.ProductTypeDraftSchema, schemas.ProductTypeSchema
        )
    ...
    def update_by_key(
        self, key: str, version: int, actions: typing.List[types.ProductTypeUpdateAction]
    ) -> types.ProductType:
        update_action = types.ProductTypeUpdate(version=version, actions=actions)
        return self._client._post(
    ...
    def delete_by_id(
        ...
        params = ProductTypeDeleteSchema().dump(
            {
                "version": version,
            }
        )
        return self._client._delete(f"product-types/{id}", params, schemas.ProductTypeSchema)
