...
class DiscountCodeService(abstract.AbstractService):
    ...
    ) -> typing.Awaitable[types.DiscountCode]:
        params = self._serialize_params({"expand": expand}, traits.ExpandableSchema)
        return self._client._get(
            endpoint=f"discount-codes/{id}",
            params=params,
            schema_cls=schemas.DiscountCodeSchema,
        )
    ...
    def query(
        ...
        *,
    ...
    ) -> typing.Awaitable[types.DiscountCodePagedQueryResponse]:
        ...
        return self._client._get(
            ...
            params=params,
            schema_cls=schemas.DiscountCodePagedQueryResponseSchema,
        )
    ...
    def update_by_id(
        ...
        id: str,
        version: int,
        actions: typing.List[types.DiscountCodeUpdateAction],
        *,
        expand: OptionalListStr = None,
