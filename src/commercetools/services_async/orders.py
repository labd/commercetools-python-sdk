...
class OrderService(abstract.AbstractService):
    ...
    def order_edit_get_by_id(
        self, id: str, *, expand: OptionalListStr = None
    ) -> typing.Awaitable[types.OrderEdit]:
        params = self._serialize_params({"expand": expand}, traits.ExpandableSchema)
        return self._client._get(
    ...
    ) -> typing.Awaitable[types.OrderEditPagedQueryResponse]:
    ...
    def import_(self, draft: types.OrderImportDraft) -> typing.Awaitable[types.Order]:
    ...
    def order_edit_apply(
        self, action: types.OrderEditApply
    ) -> typing.Awaitable[types.OrderEdit]:
        params = {}
        return self._client._post(
