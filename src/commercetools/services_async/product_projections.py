...
class ProductProjectionService(abstract.AbstractService):
    ...
    def get_by_id(
        ...
        *,
        ...
        staged: bool = None,
    ) -> typing.Awaitable[types.ProductProjection]:
    ...
    def query(
        ...
        *,
        ...
        store_projection: OptionalListStr = None,
        staged: bool = None,
    ) -> typing.Awaitable[types.ProductProjectionPagedQueryResponse]:
    ...
    ) -> typing.Awaitable[types.ProductProjectionPagedSearchResponse]:
