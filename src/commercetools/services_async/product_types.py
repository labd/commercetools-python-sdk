...
class ProductTypeService(abstract.AbstractService):
    ...
    ) -> typing.Awaitable[types.ProductType]:
        params = self._serialize_params({"expand": expand}, traits.ExpandableSchema)
        return self._client._get(
            endpoint=f"product-types/{id}",
            params=params,
            schema_cls=schemas.ProductTypeSchema,
        )
    ...
    def query(
        ...
        *,
    ...
    ) -> typing.Awaitable[types.ProductTypePagedQueryResponse]:
        ...
        return self._client._get(
            ...
            params=params,
            schema_cls=schemas.ProductTypePagedQueryResponseSchema,
        )
    ...
    def create(
        ...
        return self._client._post(
            ...
            params=params,
            data_object=draft,
            request_schema_cls=schemas.ProductTypeDraftSchema,
