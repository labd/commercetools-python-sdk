...
class SubscriptionService(abstract.AbstractService):
    ...
    def query(
        ...
        *,
    ...
    ) -> typing.Awaitable[types.SubscriptionPagedQueryResponse]:
        """Subscriptions allow you to be notified of new messages or changes via a
        Message Queue of your choice
        """
        ...
        return self._client._get(
            ...
            params=params,
            schema_cls=schemas.SubscriptionPagedQueryResponseSchema,
        )

    def create(
        self, draft: types.SubscriptionDraft, *, expand: OptionalListStr = None
    ) -> typing.Awaitable[types.Subscription]:
        ...
        return self._client._post(
            ...
            params=params,
            data_object=draft,
            request_schema_cls=schemas.SubscriptionDraftSchema,
    ...
    def update_by_id(
        ...
        id: str,
        version: int,
        actions: typing.List[types.SubscriptionUpdateAction],
        *,
        expand: OptionalListStr = None,
