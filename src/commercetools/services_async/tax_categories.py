...
class TaxCategoryService(abstract.AbstractService):
    ...
    ) -> typing.Awaitable[types.TaxCategory]:
        params = self._serialize_params({"expand": expand}, traits.ExpandableSchema)
        return self._client._get(
            endpoint=f"tax-categories/{id}",
            params=params,
            schema_cls=schemas.TaxCategorySchema,
        )
    ...
    def query(
        ...
        *,
    ...
    ) -> typing.Awaitable[types.TaxCategoryPagedQueryResponse]:
        ...
        return self._client._get(
            ...
            params=params,
            schema_cls=schemas.TaxCategoryPagedQueryResponseSchema,
        )
    ...
    def create(
        ...
        return self._client._post(
            ...
            params=params,
            data_object=draft,
            request_schema_cls=schemas.TaxCategoryDraftSchema,
    ...
    def update_by_id(
        ...
        id: str,
        version: int,
        actions: typing.List[types.TaxCategoryUpdateAction],
        *,
        expand: OptionalListStr = None,
