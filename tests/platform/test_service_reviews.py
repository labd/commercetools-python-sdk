...
def test_create_review(client):
    review = client.reviews.create(draft=models.ReviewDraft(rating=3))
...
def test_query(client):
    client.reviews.create(draft=models.ReviewDraft(key="test-review-1"))
    client.reviews.create(draft=models.ReviewDraft(key="test-review-2"))
